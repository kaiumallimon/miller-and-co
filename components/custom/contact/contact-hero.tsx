...
export default function ContactHero() {
  ...
  return (
    <section className="relative w-full min-h-[60vh] lg:min-h-[68vh] overflow-hidden">
      {/* Background Image */}
      <motion.div
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col justify-center min-h-[60vh] lg:min-h-[68vh] max-w-7xl mx-auto px-6 lg:px-10 pt-48 pb-20">
        <motion.div
        ...
        >
          ...
          >
            Get in{" "}
            <span className="italic text-[#c8a96e]">Touch</span>
          </motion.h1>
